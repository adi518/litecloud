...
require('./src/assets/js/vendor/jquery.$$.min.js');
...
if (isdev) {
    const mock = require('./src/assets/js/dev/mock.js');
    SC = mock.SC;
        ...
        if (tracks.length) {
            tracks.forEach(function (track) {
                ...
                if (track.artwork_url) {
                    ...
                    if (isdev) {
                        // TODO: restore JSON remote path to thumbnails
                        track.artwork_url = track.artwork_url.replace(/https:\/\/i1.sndcdn.com/g, 'src/assets/images/mock');
                    }
                }
